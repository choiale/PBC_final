          ...
          <Col xs={12} md={6} lg={4}>
            ...
            <Form>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" placeholder="닉네임을 입력하세요" style={{ backgroundColor: '#f1f2f7' }} />
              </Form.Group>
              <Form.Group className="mb-4">
                <Form.Label>비밀번호</Form.Label>
                <Form.Control type="password" placeholder="비밀번호를 입력하세요" style={{ backgroundColor: '#f1f2f7' }} />
              </Form.Group>
              <div className="d-grid">
                <Button variant="primary" style={{ backgroundColor: '#a99dd8', border: 'none' }}>확인</Button>
              </div>
            </Form>
          </Col>
        </Row>
        ...
        <Container>
          <Row>
            <Col md={6}>
              ...
              <div className="mt-2">
                <i className="me-2"><BsInstagram /></i>
                <i><BsYoutube /></i>
              </div>
            </Col>
